...
import 'features/calendar/data/datasources/f_c_pill_history_datasource.dart';
import 'features/calendar/data/repositories/f_calendar_repo_impl.dart';
import 'features/calendar/domain/repositories/f_calendar_repo.dart';
import 'features/calendar/domain/usecases/f_c_get_day_pill_history_usecase.dart';
import 'features/calendar/domain/usecases/f_c_get_month_pill_history_usecase.dart';
...
Future<void> fCalendar() async {
  ...
  sl.registerLazySingleton<FCGetMonthPillHistoryUsecase>(
